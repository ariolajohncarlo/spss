...
class ComponentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component_type" do
    assert_difference('ComponentType.count') do
      post component_types_url, params: { component_type: { type_description: @component_type.type_description } }
    end
  ...
  test "should update component_type" do
    patch component_type_url(@component_type), params: { component_type: { type_description: @component_type.type_description } }
